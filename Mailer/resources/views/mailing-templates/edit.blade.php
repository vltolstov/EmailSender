...
@section('edit-template-form')
    ...
    <div class="row">
        <div class="col-lg-12">
            <form action="{{route('mailing-templates.update', $mailingTemplate->id)}}" method="POST">
                @csrf
                @method('PUT')
                <div class="add-template-form">
                    ...
                    <div class="bord @error('name') form-error @enderror">
                        ...
                        @enderror
                        <input type="text" name="name" placeholder="Название" value="{{$mailingTemplate->name}}" maxlength="150" class="input-name">
                    </div>
